...
if __name__ == '__main__':
    test_images = [plt.imread(path) for path in
                   glob.glob('E:\\Workspace\\ml\\code-ml\\ml\\python\\computer-vision\\data\\test_images\\*')]
    weights_path = 'car1.h5'
    video_name = 'E:\\Workspace\\ml\\code-ml\\ml\\python\\computer-vision\\data\\parking_video.mp4'

    # 模型返回0 或者1 所以这里转换为string类型
    class_dictionary = {}
